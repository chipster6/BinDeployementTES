...
const getBinsValidation = [
  ...
  query('sortBy')
    .optional()
    .isIn(['created_at', 'updated_at', 'bin_number', 'status', 'bin_type', 'fill_level_percent', 'next_service_date'])
...
router.post('/', authenticateToken, createBinValidation, BinController.createBin);
...
router.get('/analytics/overview', authenticateToken, BinController.getBinAnalytics);

// @route   GET /api/v1/bins/customer/:customerId
// @desc    Get bins by customer
// @access  Private (Admin, Office Staff, Customer owns)
router.get('/customer/:customerId', authenticateToken, customerIdValidation, BinController.getBinsByCustomer);

// @route   GET /api/v1/bins/:id
// @desc    Get bin by ID
// @access  Private (Admin, Office Staff, Dispatcher, Driver, Customer owns)
router.get('/:id', authenticateToken, binIdValidation, BinController.getBinById);

// @route   PUT /api/v1/bins/:id
// @desc    Update bin information
// @access  Private (Admin, Office Staff)
router.put('/:id', authenticateToken, binIdValidation, updateBinValidation, BinController.updateBin);

// @route   DELETE /api/v1/bins/:id
// @desc    Delete bin (soft delete)
// @access  Private (Admin)
router.delete('/:id', authenticateToken, binIdValidation, BinController.deleteBin);
...
router.put('/:id/fill-level', authenticateToken, binIdValidation, updateFillLevelValidation, BinController.updateFillLevel);
...
router.get('/:id/sensor-data', authenticateToken, binIdValidation, (req, res) => {
...
router.post('/:id/sensor-data', authenticateToken, binIdValidation, (req, res) => {
...
// @access  Private (Admin, Office Staff, Customer owns)
router.get('/:id/service-history', authenticateToken, binIdValidation, (req, res) => {
