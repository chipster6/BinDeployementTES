...
// Validation middleware removed - using Joi validation in routes instead

// Login validation removed - using Joi validation in routes instead

// Password change validation removed - using Joi validation in routes instead
