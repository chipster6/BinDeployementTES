...
exports.ProductionReadinessValidator = void 0;
exports.executeProductionReadinessValidation = executeProductionReadinessValidation;
...
class ProductionReadinessValidator {
    ...
    async validateConnectionPoolScaling() {
        const poolStats = await (0, database_1.getConnectionPoolStats)();
        const testResult = {
    ...
    async validateSpatialQueryOptimization() {
        const testResult = {
    ...
    async testSecurityPerformanceIntegration() {
        return {
    ...
    async testSpatialSecurityIntegration() {
        return {
    ...
    async checkDatabaseHealth() {
        try {
            const healthCheck = await (0, database_1.checkDatabaseHealth)();
            const poolStats = await (0, database_1.getConnectionPoolStats)();
            return {
    ...
    calculateOverallScore(assessment) {
        ...
        return Math.round(assessment.securityValidation.score * weights.security +
    ...
    calculateConfidenceLevel(assessment) {
        const factors = [
    ...
    makeDeploymentRecommendation(assessment) {
...
BUSINESS IMPACT: $2M+ MRR operations protected with enterprise-grade security and performance optimizations ready for production scale.
    ...
    generateTechnicalSummary(assessment) {
        return `
...
- Performance: ${assessment.systemHealth.performance.status}
    ...
    generateDeploymentChecklist(assessment) {
        const checklist = [
    ...
    generateSecurityRecommendations(fixes) {
    ...
    generatePerformanceRecommendations(optimizations) {
        return [
    ...
    generateIntegrationRecommendations(conflicts) {
        const recommendations = [
...
exports.ProductionReadinessValidator = ProductionReadinessValidator;
async function executeProductionReadinessValidation() {
    const validator = new ProductionReadinessValidator();
    return await validator.validateProductionReadiness();
}
//# sourceMappingURL=ProductionReadinessValidation.js.map